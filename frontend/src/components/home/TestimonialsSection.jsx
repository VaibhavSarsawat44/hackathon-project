        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-slate-800/50 p-8 rounded-3xl shadow-lg border border-slate-700 flex flex-col justify-between hover:shadow-[0_0_40px_rgba(14,165,233,0.15)] hover:border-slate-600 transition-all backdrop-blur-sm"
            >
              <div>
                ...
                <p className="text-slate-300 leading-relaxed mb-8 font-medium">"{testimonial.content}"</p>
              </div>
