...
const stats = [
  { id: 1, name: 'Active Users', value: '250K+' },
  { id: 2, name: 'Destinations', value: '1,200+' },
  { id: 3, name: 'Bookings Made', value: '5M+' },
  { id: 4, name: 'Partner Hotels', value: '15,000+' },
];
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-center">
          {stats.map((stat, index) => (
            <motion.div 
              ...
              className="glass-dark p-6 md:p-8 rounded-2xl flex flex-col items-center justify-center"
            >
