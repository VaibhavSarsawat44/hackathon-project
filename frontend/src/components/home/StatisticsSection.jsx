        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 text-center">
          {stats.map((stat, index) => (
            <motion.div 
              ...
              className="glass-dark p-6 md:p-8 rounded-2xl flex flex-col items-center justify-center bg-gray-950/60 border border-gray-800 shadow-lg backdrop-blur-md hover:border-primary-500/50 transition-colors"
            >
