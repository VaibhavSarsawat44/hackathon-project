...
import { Search, Filter, SortDesc, Grid, Plus, MapPin, Calendar, Home, LogOut } from 'lucide-react';
...
const Dashboard = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    getTrips().then(res => setTrips(res.data?.data?.trips || [])).catch(() => {});
  }, []);
    ...
    <div className="min-h-screen bg-gray-950 text-white pb-24 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        >
          ...
          <Link to="/" className="flex items-center gap-2 text-gray-400 hover:text-white bg-gray-900/60 hover:bg-gray-800 border border-gray-800 hover:border-gray-600 px-4 py-2.5 rounded-xl transition-all group">
          ...
          <div className="flex items-center gap-3">
            <span className="text-gray-400 text-sm hidden sm:block">Hi, <span className="text-white font-medium">{user?.name || 'Traveler'}</span></span>
